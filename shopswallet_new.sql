...
(1, 'Mutasim', 'Naib', '1724698392', 'mutasim@gmail.com', NULL, '$2y$10$ebK6q/lohfLkQQfZyLdaMugVLpF0lU9ivZebpqUX7YO6uU5dBRXae', '4CJjcYnTrK5UJSkuzEYOOZiM56GdoLVZAwXxaUKqnPBE0nZLjkP0LZHfq6Nk', '2025-07-07 04:40:41', '2025-07-07 04:40:41', 1, NULL, 1);
...
CREATE TABLE `advertisements` (
  ...
  `pause_note` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'TESTB', 'testb', '2025-07-07-686bf0a818618.png', 1, '2025-07-07 05:07:04', '2025-07-07 05:07:04', 1);
...
(139, 'check_daily_subscription_validity_check', '2025-07-07', '2024-06-05 20:15:07', '2025-07-07 04:47:45'),
...
CREATE TABLE `email_templates` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `body_2` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `items` (
  ...
  `food_variations` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `zone_id` bigint(20) UNSIGNED DEFAULT NULL,
  `module_id` bigint(20) UNSIGNED NOT NULL,
  `order_attachment` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `order_proof` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(9, 'App\\Models\\BusinessSetting', '139', NULL, 'public', '2025-07-07 04:47:45', '2025-07-07 04:47:45'),
...
(88, 'App\\Models\\Brand', '1', 'image', 'public', '2025-07-07 05:07:04', '2025-07-07 05:07:04');
...
(45, 'App\\Models\\Brand', 1, 'en', 'name', 'TESTB', NULL, NULL);
