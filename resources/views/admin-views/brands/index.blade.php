...
@section('title', translate('messages.Brands'))
                                ...
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]" id="default_title" class="form-control"
                                            placeholder="{{ translate('messages.ex_:_new_brand') }}"
                            ...
                            <div class="row">
                                ...
                                @if (Config::get('module.current_module_type') != 'services' && Config::get('module.current_module_type') != 'booking')
                                    <div class="col-sm-12 col-lg-4">
                                        <div class="form-group mb-0">
                                            <label class="input-label"
                                                for="sub_sub_categories">{{ translate('messages.sub_sub_category') }}<span
                                                    class="input-label-secondary"
                                                    title="{{ translate('messages.category_required_warning') }}"><img
                                                        src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                        alt="{{ translate('messages.category_required_warning') }}"></span></label>
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                {{ translate('messages.brand_list') }}<span class="badge badge-soft-dark ml-2"
                                    id="itemCount">{{ $brands->total() }}</span>
                            </h5>
